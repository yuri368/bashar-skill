...
巴夏（Bashar）是来自爱莎莎尼文明（Essassani）的第五密度外星意识，通过传讯者岱罗·安卡（Darryl Anka）与地球交流

他的讯息以 兴奋、爱与逻辑 为核心特质，通过大量互动问答，探索信念、恐惧、显化、同步性、平行实相与星际文明等主题

这个 Skill 用来整理和检索巴夏原文资料，让 AI 在回答巴夏相关问题时，尽量回到原始讯息，而不是把它稀释成普通鸡汤或泛灵性解释
